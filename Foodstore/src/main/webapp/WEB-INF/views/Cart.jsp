...
.carousel-caption h3 {
  ...
  background-repeat: no-repeat;
    ...
    .item:nth-child(3) {
      background: url('https://i.ytimg.com/vi/-CKvt1KNU74/maxresdefault.jpg');
  background-size: cover;
  background-position: center center;
  background-repeat: no-repeat;
    }
			...
			<c:forEach var="list1" items="${cart1}">
                ...
                <td><c:out value="${list1.productId}"/></td>
                 ...
                 <td><c:out value="${list1.quantity}" /></td>
                  ...
                  <td><form>
                  <button  class="btn btn-info btn-lg" name = "ProductId" value = "${list1.productId}" type = "submit" formmethod="post" formaction="/Foodstore/delete1"> <span class="glyphicon glyphicon-trash">Remove</span></button></form></td>
                </tr>
            </c:forEach>
            </tbody>
            </table>
